...
//     //     },
//     // canActivate: [AuthGuard],
//     path: 'main',  component: DefaultLayoutComponent,
//     children: [
...
//       { path: 'forms', loadChildren: () => import('./views/forms/forms.module').then(m => m.CoreUIFormsModule) },
//       { path: 'charts', loadChildren: () => import('./views/charts/charts.module').then(m => m.ChartsModule) },
...
//   // { path: '**', redirectTo: '404' } // Handle any other routes
// ];
